    ...
    return (
      <div className="w-full px-4 sm:px-8 lg:px-24 mt-56 ">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 items-center  ">
          ...
          <div data-aos="zoom-in-right" className="flex flex-col justify-center items-center bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 h-[350px]">
          ...
          <div data-aos="flip-left" className="flex flex-col justify-center items-center bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 h-[300px]">
            <div className="flex items-center mb-4">
              <img
                className="w-16 h-16 rounded-full object-cover mr-4"
          ...
          <div data-aos="zoom-in-left" className="flex flex-col justify-center items-center bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 h-[250px]">
            <div className="flex items-center mb-4">
              <img
                className="w-16 h-16 rounded-full object-cover mr-4"
